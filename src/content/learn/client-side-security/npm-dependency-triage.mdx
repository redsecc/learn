---
title: "NPM dependency triage"
order: 36
summary: "Learn NPM dependency triage through a safe, repeatable client-side security workflow."
tags: ["client-side-security","npm","advanced","lab"]
level: advanced
kind: lab
duration: "45 min"
---
...
This lab is part of the **Client-side security** track. It focuses on **NPM dependency triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
NPM dependency triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "NPM dependency triage" means in this track before using a tool.

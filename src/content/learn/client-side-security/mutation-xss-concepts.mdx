---
title: "Mutation XSS concepts"
order: 24
summary: "Learn Mutation XSS concepts through a safe, repeatable client-side security workflow."
tags: ["client-side-security","mutation","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---

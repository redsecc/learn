---
title: "Subresource integrity basics"
order: 37
summary: "Learn Subresource integrity basics through a safe, repeatable client-side security workflow."
tags: ["client-side-security","subresource","advanced","reference"]
level: advanced
kind: reference
duration: "12 min"
---
...
This reference is part of the **Client-side security** track. It focuses on **Subresource integrity basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Subresource integrity basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Subresource integrity basics" means in this track before using a tool.

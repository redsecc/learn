...
tags: ["client-side-security","client","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Client-side security** track. It focuses on **Client-side route guards** as a practical skill you can apply in labs, CTFs, and authorized assessments.

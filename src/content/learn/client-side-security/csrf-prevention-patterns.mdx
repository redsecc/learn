...
tags: ["client-side-security","csrf","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Client-side security** track. It focuses on **CSRF prevention patterns** as a practical skill you can apply in labs, CTFs, and authorized assessments.

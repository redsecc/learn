...
tags: ["client-side-security","javascript","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Client-side security** track. It focuses on **JavaScript bundle review** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["client-side-security","clickjacking","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Client-side security** track. It focuses on **Clickjacking defenses** as a practical skill you can apply in labs, CTFs, and authorized assessments.

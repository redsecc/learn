---
title: "radare2 orientation"
order: 36
summary: "Learn radare2 orientation through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","radare2","advanced","lab"]
level: advanced
kind: lab
duration: "45 min"
---
...
This lab is part of the **Reverse engineering** track. It focuses on **radare2 orientation** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
radare2 orientation is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

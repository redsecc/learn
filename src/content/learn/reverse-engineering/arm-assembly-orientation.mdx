---
title: "ARM assembly orientation"
order: 26
summary: "Learn ARM assembly orientation through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","arm","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **ARM assembly orientation** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
ARM assembly orientation is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

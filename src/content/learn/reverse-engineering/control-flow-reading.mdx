...
tags: ["reverse-engineering","control","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Reverse engineering** track. It focuses on **Control flow reading** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "ltrace and strace workflow"
order: 37
summary: "Learn ltrace and strace workflow through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","ltrace","advanced","reference"]
level: advanced
kind: reference
duration: "12 min"
---
...
This reference is part of the **Reverse engineering** track. It focuses on **ltrace and strace workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
ltrace and strace workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

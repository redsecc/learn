...
tags: ["reverse-engineering","patching","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **Patching a toy binary** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Decompilers and assumptions"
order: 18
summary: "Learn Decompilers and assumptions through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","decompilers","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **Decompilers and assumptions** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Decompilers and assumptions is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

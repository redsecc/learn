...
tags: ["reverse-engineering","decompilers","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Reverse engineering** track. It focuses on **Decompilers and assumptions** as a practical skill you can apply in labs, CTFs, and authorized assessments.

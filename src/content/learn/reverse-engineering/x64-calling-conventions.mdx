---
title: "x64 calling conventions"
order: 25
summary: "Learn x64 calling conventions through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","x64","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **x64 calling conventions** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
x64 calling conventions is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

---
title: "Stack vs heap in disassembly"
order: 27
summary: "Learn Stack vs heap in disassembly through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","stack","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Reverse engineering** track. It focuses on **Stack vs heap in disassembly** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Stack vs heap in disassembly is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

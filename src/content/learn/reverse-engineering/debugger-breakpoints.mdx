...
tags: ["reverse-engineering","debugger","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **Debugger breakpoints** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Strings and basic triage"
order: 11
summary: "Learn Strings and basic triage through a safe, repeatable reverse engineering workflow."
tags: ["reverse-engineering","strings","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reverse engineering** track. It focuses on **Strings and basic triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Strings and basic triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

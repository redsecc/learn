---
title: "Image scanning triage"
order: 18
summary: "Learn Image scanning triage through a safe, repeatable containers workflow."
tags: ["containers","image","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Containers** track. It focuses on **Image scanning triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Image scanning triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Image scanning triage" means in this track before using a tool.

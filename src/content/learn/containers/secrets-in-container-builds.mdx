...
tags: ["containers","secrets","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Containers** track. It focuses on **Secrets in container builds** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Runtime detection signals"
order: 35
summary: "Learn Runtime detection signals through a safe, repeatable containers workflow."
tags: ["containers","runtime","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Containers** track. It focuses on **Runtime detection signals** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Runtime detection signals is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Runtime detection signals" means in this track before using a tool.

...
This reference is part of the **Containers** track. It focuses on **Kubernetes object model** as a practical skill you can apply in labs, CTFs, and authorized assessments.

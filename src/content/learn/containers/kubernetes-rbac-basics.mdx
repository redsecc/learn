---
title: "Kubernetes RBAC basics"
order: 16
summary: "Learn Kubernetes RBAC basics through a safe, repeatable containers workflow."
tags: ["containers","kubernetes","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Containers** track. It focuses on **Kubernetes RBAC basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Kubernetes RBAC basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Kubernetes RBAC basics" means in this track before using a tool.

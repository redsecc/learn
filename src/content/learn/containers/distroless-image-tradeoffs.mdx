---
title: "Distroless image tradeoffs"
order: 25
summary: "Learn Distroless image tradeoffs through a safe, repeatable containers workflow."
tags: ["containers","distroless","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Containers** track. It focuses on **Distroless image tradeoffs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Distroless image tradeoffs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Distroless image tradeoffs" means in this track before using a tool.

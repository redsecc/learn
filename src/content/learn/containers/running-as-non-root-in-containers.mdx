---
title: "Running as non-root in containers"
order: 20
summary: "Learn Running as non-root in containers through a safe, repeatable containers workflow."
tags: ["containers","running","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Containers** track. It focuses on **Running as non-root in containers** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Running as non-root in containers is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Running as non-root in containers" means in this track before using a tool.

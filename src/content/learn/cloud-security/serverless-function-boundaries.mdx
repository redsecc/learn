---
title: "Serverless function boundaries"
order: 14
summary: "Learn Serverless function boundaries through a safe, repeatable cloud security workflow."
tags: ["cloud-security","serverless","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cloud security** track. It focuses on **Serverless function boundaries** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Serverless function boundaries is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Serverless function boundaries" means in this track before using a tool.

...
tags: ["cloud-security","metadata","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cloud security** track. It focuses on **Metadata service concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.

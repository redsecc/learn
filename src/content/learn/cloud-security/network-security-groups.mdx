...
tags: ["cloud-security","network","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cloud security** track. It focuses on **Network security groups** as a practical skill you can apply in labs, CTFs, and authorized assessments.

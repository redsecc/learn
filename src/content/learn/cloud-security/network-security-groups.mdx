...
order: 17
summary: "Learn Network security groups through a safe, repeatable cloud security workflow."
tags: ["cloud-security","network","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cloud security** track. It focuses on **Network security groups** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Network security groups is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Network security groups" means in this track before using a tool.

...
tags: ["cloud-security","cloud","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Cloud security** track. It focuses on **Cloud logging for investigators** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Cloud logging for investigators"
order: 15
summary: "Learn Cloud logging for investigators through a safe, repeatable cloud security workflow."
tags: ["cloud-security","cloud","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cloud security** track. It focuses on **Cloud logging for investigators** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
- read identity policy intent
- describe exposure without changing production resources

## The core idea

Cloud logging for investigators is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
<Callout type="tip" title="Lab exercise">
  Use a personal sandbox account with billing alerts and least privilege. Prefer read-only review tasks until you understand the blast radius.
</Callout>

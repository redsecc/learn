...
tags: ["api-security","rate","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **API security** track. It focuses on **Rate limiting and abuse cases** as a practical skill you can apply in labs, CTFs, and authorized assessments.

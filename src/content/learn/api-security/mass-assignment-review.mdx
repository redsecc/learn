...
tags: ["api-security","mass","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **API security** track. It focuses on **Mass assignment review** as a practical skill you can apply in labs, CTFs, and authorized assessments.

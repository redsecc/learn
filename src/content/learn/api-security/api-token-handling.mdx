...
tags: ["api-security","api","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **API security** track. It focuses on **API token handling** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "REST endpoint inventory"
order: 10
summary: "Learn REST endpoint inventory through a safe, repeatable api security workflow."
tags: ["api-security","rest","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **API security** track. It focuses on **REST endpoint inventory** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
REST endpoint inventory is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

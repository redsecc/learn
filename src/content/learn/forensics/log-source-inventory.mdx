...
This lab is part of the **Forensics** track. It focuses on **Log source inventory** as a practical skill you can apply in labs, CTFs, and authorized assessments.

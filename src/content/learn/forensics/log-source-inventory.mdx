...
order: 13
summary: "Learn Log source inventory through a safe, repeatable forensics workflow."
tags: ["forensics","log","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **Log source inventory** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Log source inventory is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

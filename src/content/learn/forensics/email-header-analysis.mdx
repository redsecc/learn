...
This lab is part of the **Forensics** track. It focuses on **Email header analysis** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["forensics","browser","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **Browser artifact review** as a practical skill you can apply in labs, CTFs, and authorized assessments.

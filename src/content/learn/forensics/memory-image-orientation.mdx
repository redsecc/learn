...
tags: ["forensics","memory","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Forensics** track. It focuses on **Memory image orientation** as a practical skill you can apply in labs, CTFs, and authorized assessments.

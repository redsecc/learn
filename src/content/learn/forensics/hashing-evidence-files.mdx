---
title: "Hashing evidence files"
order: 18
summary: "Learn Hashing evidence files through a safe, repeatable forensics workflow."
tags: ["forensics","hashing","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Forensics** track. It focuses on **Hashing evidence files** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Hashing evidence files is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

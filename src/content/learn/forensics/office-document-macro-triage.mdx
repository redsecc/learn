---
title: "Office document macro triage"
order: 27
summary: "Learn Office document macro triage through a safe, repeatable forensics workflow."
tags: ["forensics","office","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Forensics** track. It focuses on **Office document macro triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Office document macro triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

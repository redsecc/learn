---
title: "File carving basics"
order: 20
summary: "Learn File carving basics through a safe, repeatable forensics workflow."
tags: ["forensics","file","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **File carving basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
File carving basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

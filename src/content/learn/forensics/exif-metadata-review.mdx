---
title: "Exif metadata review"
order: 22
summary: "Learn Exif metadata review through a safe, repeatable forensics workflow."
tags: ["forensics","exif","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **Exif metadata review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Exif metadata review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

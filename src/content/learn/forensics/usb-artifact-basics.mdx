---
title: "USB artifact basics"
order: 32
summary: "Learn USB artifact basics through a safe, repeatable forensics workflow."
tags: ["forensics","usb","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **USB artifact basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
USB artifact basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

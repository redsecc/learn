...
order: 31
summary: "Learn DNS tunneling indicators through a safe, repeatable forensics workflow."
tags: ["forensics","dns","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Forensics** track. It focuses on **DNS tunneling indicators** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
DNS tunneling indicators is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

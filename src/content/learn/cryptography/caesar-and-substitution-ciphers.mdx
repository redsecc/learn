---
title: "Caesar and substitution ciphers"
order: 22
summary: "Learn Caesar and substitution ciphers through a safe, repeatable cryptography workflow."
tags: ["cryptography","caesar","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cryptography** track. It focuses on **Caesar and substitution ciphers** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Caesar and substitution ciphers is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

...
tags: ["cryptography","symmetric","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cryptography** track. It focuses on **Symmetric encryption modes** as a practical skill you can apply in labs, CTFs, and authorized assessments.

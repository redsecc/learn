---
title: "Symmetric encryption modes"
order: 13
summary: "Learn Symmetric encryption modes through a safe, repeatable cryptography workflow."
tags: ["cryptography","symmetric","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cryptography** track. It focuses on **Symmetric encryption modes** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Symmetric encryption modes is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

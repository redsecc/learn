...
tags: ["cryptography","key","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cryptography** track. It focuses on **Key rotation planning** as a practical skill you can apply in labs, CTFs, and authorized assessments.

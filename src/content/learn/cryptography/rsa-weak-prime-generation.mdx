---
title: "RSA weak prime generation"
order: 27
summary: "Learn RSA weak prime generation through a safe, repeatable cryptography workflow."
tags: ["cryptography","rsa","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cryptography** track. It focuses on **RSA weak prime generation** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
RSA weak prime generation is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

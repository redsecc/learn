...
tags: ["cryptography","replay","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Cryptography** track. It focuses on **Replay protection and nonces** as a practical skill you can apply in labs, CTFs, and authorized assessments.

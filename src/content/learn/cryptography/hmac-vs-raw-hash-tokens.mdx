---
title: "HMAC vs raw hash tokens"
order: 33
summary: "Learn HMAC vs raw hash tokens through a safe, repeatable cryptography workflow."
tags: ["cryptography","hmac","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cryptography** track. It focuses on **HMAC vs raw hash tokens** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
HMAC vs raw hash tokens is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

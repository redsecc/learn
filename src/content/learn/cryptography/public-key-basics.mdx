---
title: "Public key basics"
order: 14
summary: "Learn Public key basics through a safe, repeatable cryptography workflow."
tags: ["cryptography","public","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cryptography** track. It focuses on **Public key basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Public key basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

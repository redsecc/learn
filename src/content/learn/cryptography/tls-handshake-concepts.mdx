...
tags: ["cryptography","tls","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Cryptography** track. It focuses on **TLS handshake concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.

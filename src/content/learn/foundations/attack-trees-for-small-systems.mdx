---
title: "Attack trees for small systems"
order: 22
summary: "Learn Attack trees for small systems through a safe, repeatable security foundations workflow."
tags: ["foundations","attack","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Attack trees for small systems** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Attack trees for small systems is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Attack trees for small systems" means in this track before using a tool.

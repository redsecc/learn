---
title: "Threat actors, capabilities, and intent"
order: 21
summary: "Learn Threat actors, capabilities, and intent through a safe, repeatable security foundations workflow."
tags: ["foundations","threat","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Threat actors, capabilities, and intent** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Threat actors, capabilities, and intent is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Threat actors, capabilities, and intent" means in this track before using a tool.

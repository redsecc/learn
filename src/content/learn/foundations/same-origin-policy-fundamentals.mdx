---
title: "Same-origin policy fundamentals"
order: 14
summary: "Learn Same-origin policy fundamentals through a safe, repeatable security foundations workflow."
tags: ["foundations","same","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Same-origin policy fundamentals** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Same-origin policy fundamentals is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Same-origin policy fundamentals" means in this track before using a tool.

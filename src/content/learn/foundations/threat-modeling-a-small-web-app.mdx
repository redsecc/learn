...
tags: ["foundations","threat","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Security foundations** track. It focuses on **Threat modeling a small web app** as a practical skill you can apply in labs, CTFs, and authorized assessments.

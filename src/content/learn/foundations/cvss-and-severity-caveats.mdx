---
title: "CVSS and severity caveats"
order: 30
summary: "Learn CVSS and severity caveats through a safe, repeatable security foundations workflow."
tags: ["foundations","cvss","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Security foundations** track. It focuses on **CVSS and severity caveats** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CVSS and severity caveats is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "CVSS and severity caveats" means in this track before using a tool.

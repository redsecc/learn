---
title: "Risk, likelihood, and impact"
order: 16
summary: "Learn Risk, likelihood, and impact through a safe, repeatable security foundations workflow."
tags: ["foundations","risk","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Security foundations** track. It focuses on **Risk, likelihood, and impact** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Risk, likelihood, and impact is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Risk, likelihood, and impact" means in this track before using a tool.

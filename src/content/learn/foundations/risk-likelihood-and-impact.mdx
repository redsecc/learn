...
tags: ["foundations","risk","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Risk, likelihood, and impact** as a practical skill you can apply in labs, CTFs, and authorized assessments.

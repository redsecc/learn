...
tags: ["foundations","authentication","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Authentication vs authorization** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["foundations","http","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Security foundations** track. It focuses on **HTTP request and response anatomy** as a practical skill you can apply in labs, CTFs, and authorized assessments.

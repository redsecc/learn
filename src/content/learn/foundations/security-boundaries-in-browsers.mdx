---
title: "Security boundaries in browsers"
order: 33
summary: "Learn Security boundaries in browsers through a safe, repeatable security foundations workflow."
...
This tutorial is part of the **Security foundations** track. It focuses on **Security boundaries in browsers** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Security boundaries in browsers is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Security boundaries in browsers" means in this track before using a tool.

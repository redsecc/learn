...
order: 11
summary: "Learn Assets, threats, and controls through a safe, repeatable security foundations workflow."
tags: ["foundations","assets","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Security foundations** track. It focuses on **Assets, threats, and controls** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Assets, threats, and controls is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Assets, threats, and controls" means in this track before using a tool.

---
title: "Security requirements from user stories"
order: 25
summary: "Learn Security requirements from user stories through a safe, repeatable security foundations workflow."
...
This tutorial is part of the **Security foundations** track. It focuses on **Security requirements from user stories** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Security requirements from user stories is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Security requirements from user stories" means in this track before using a tool.

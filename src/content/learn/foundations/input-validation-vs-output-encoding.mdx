...
tags: ["foundations","input","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Security foundations** track. It focuses on **Input validation vs output encoding** as a practical skill you can apply in labs, CTFs, and authorized assessments.

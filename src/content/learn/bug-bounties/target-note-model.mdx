...
tags: ["bug-bounties","target","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Bug bounties** track. It focuses on **Target note model** as a practical skill you can apply in labs, CTFs, and authorized assessments.

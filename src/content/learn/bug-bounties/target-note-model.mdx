---
title: "Target note model"
order: 13
summary: "Learn Target note model through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","target","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Target note model** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Target note model is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Target note model" means in this track before using a tool.

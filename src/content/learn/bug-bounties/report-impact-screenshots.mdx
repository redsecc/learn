---
title: "Report impact screenshots"
order: 31
summary: "Learn Report impact screenshots through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","report","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Report impact screenshots** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Report impact screenshots is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Report impact screenshots" means in this track before using a tool.

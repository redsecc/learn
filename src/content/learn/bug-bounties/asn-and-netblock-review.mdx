---
title: "ASN and netblock review"
order: 21
summary: "Learn ASN and netblock review through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","asn","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **ASN and netblock review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
ASN and netblock review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "ASN and netblock review" means in this track before using a tool.

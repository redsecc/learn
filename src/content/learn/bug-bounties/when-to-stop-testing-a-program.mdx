---
title: "When to stop testing a program"
order: 35
summary: "Learn When to stop testing a program through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","when","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **When to stop testing a program** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
When to stop testing a program is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "When to stop testing a program" means in this track before using a tool.

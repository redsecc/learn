---
title: "Recon from program scope"
order: 20
summary: "Learn Recon from program scope through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","recon","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Recon from program scope** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Recon from program scope is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Recon from program scope" means in this track before using a tool.

---
title: "Communicating with triage"
order: 17
summary: "Learn Communicating with triage through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","communicating","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Communicating with triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Communicating with triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Communicating with triage" means in this track before using a tool.

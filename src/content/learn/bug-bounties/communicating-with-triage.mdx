...
tags: ["bug-bounties","communicating","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Bug bounties** track. It focuses on **Communicating with triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.

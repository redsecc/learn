...
order: 14
summary: "Learn Duplicate avoidance through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","duplicate","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Duplicate avoidance** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Duplicate avoidance is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Duplicate avoidance" means in this track before using a tool.

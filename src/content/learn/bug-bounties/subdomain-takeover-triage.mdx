---
title: "Subdomain takeover triage"
order: 22
summary: "Learn Subdomain takeover triage through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","subdomain","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Subdomain takeover triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Subdomain takeover triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Subdomain takeover triage" means in this track before using a tool.

---
title: "Choosing a beginner program"
order: 10
summary: "Learn Choosing a beginner program through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","choosing","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Bug bounties** track. It focuses on **Choosing a beginner program** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Choosing a beginner program is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Choosing a beginner program" means in this track before using a tool.

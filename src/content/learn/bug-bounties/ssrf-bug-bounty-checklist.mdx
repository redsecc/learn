---
title: "SSRF bug bounty checklist"
order: 27
summary: "Learn SSRF bug bounty checklist through a safe, repeatable bug bounties workflow."
tags: ["bug-bounties","ssrf","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Bug bounties** track. It focuses on **SSRF bug bounty checklist** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
SSRF bug bounty checklist is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "SSRF bug bounty checklist" means in this track before using a tool.

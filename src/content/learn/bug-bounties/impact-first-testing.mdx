...
tags: ["bug-bounties","impact","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Bug bounties** track. It focuses on **Impact-first testing** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Using ripgrep for source review"
order: 31
summary: "Learn Using ripgrep for source review through a safe, repeatable tools and workflows workflow."
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Using ripgrep for source review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Using ripgrep for source review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Using ripgrep for source review" means in this track before using a tool.

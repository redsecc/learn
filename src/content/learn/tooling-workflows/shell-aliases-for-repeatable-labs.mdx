---
title: "Shell aliases for repeatable labs"
order: 21
summary: "Learn Shell aliases for repeatable labs through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","shell","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Shell aliases for repeatable labs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Shell aliases for repeatable labs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Shell aliases for repeatable labs" means in this track before using a tool.

---
title: "ZAP baseline review workflow"
order: 26
summary: "Learn ZAP baseline review workflow through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","zap","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Tools and workflows** track. It focuses on **ZAP baseline review workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
ZAP baseline review workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "ZAP baseline review workflow" means in this track before using a tool.

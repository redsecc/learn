---
title: "Organizing Burp or ZAP projects"
order: 16
summary: "Learn Organizing Burp or ZAP projects through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","organizing","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Tools and workflows** track. It focuses on **Organizing Burp or ZAP projects** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Organizing Burp or ZAP projects is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Organizing Burp or ZAP projects" means in this track before using a tool.

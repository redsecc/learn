---
title: "Wordlist selection and tuning"
order: 12
summary: "Learn Wordlist selection and tuning through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","wordlist","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Wordlist selection and tuning** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Wordlist selection and tuning is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Wordlist selection and tuning" means in this track before using a tool.

...
tags: ["tooling-workflows","building","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Tools and workflows** track. It focuses on **Building small helper scripts** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Using tmux for long lab sessions"
order: 20
summary: "Learn Using tmux for long lab sessions through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","using","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Using tmux for long lab sessions** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Using tmux for long lab sessions is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Using tmux for long lab sessions" means in this track before using a tool.

---
title: "HTTP history triage"
order: 27
summary: "Learn HTTP history triage through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","http","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Tools and workflows** track. It focuses on **HTTP history triage** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
HTTP history triage is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "HTTP history triage" means in this track before using a tool.

---
title: "Burp Intruder safety settings"
order: 25
summary: "Learn Burp Intruder safety settings through a safe, repeatable tools and workflows workflow."
tags: ["tooling-workflows","burp","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Burp Intruder safety settings** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Burp Intruder safety settings is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Burp Intruder safety settings" means in this track before using a tool.

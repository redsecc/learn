---
title: "Burp Repeater workflow"
order: 24
summary: "Learn Burp Repeater workflow through a safe, repeatable tools and workflows workflow."
...
This tutorial is part of the **Tools and workflows** track. It focuses on **Burp Repeater workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Burp Repeater workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Burp Repeater workflow" means in this track before using a tool.

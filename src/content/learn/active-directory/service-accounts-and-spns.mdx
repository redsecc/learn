---
title: "Service accounts and SPNs"
order: 14
summary: "Learn Service accounts and SPNs through a safe, repeatable active directory workflow."
tags: ["active-directory","service","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Service accounts and SPNs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Service accounts and SPNs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Service accounts and SPNs" means in this track before using a tool.

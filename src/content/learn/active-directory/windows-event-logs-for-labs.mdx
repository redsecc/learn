...
tags: ["active-directory","windows","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Windows event logs for labs** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "BloodHound graph reading"
order: 23
summary: "Learn BloodHound graph reading through a safe, repeatable active directory workflow."
tags: ["active-directory","bloodhound","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Active Directory** track. It focuses on **BloodHound graph reading** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
BloodHound graph reading is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "BloodHound graph reading" means in this track before using a tool.

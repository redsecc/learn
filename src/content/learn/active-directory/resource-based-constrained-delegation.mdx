...
order: 26
summary: "Learn Resource based constrained delegation through a safe, repeatable active directory workflow."
tags: ["active-directory","resource","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Resource based constrained delegation** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Resource based constrained delegation is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Resource based constrained delegation" means in this track before using a tool.

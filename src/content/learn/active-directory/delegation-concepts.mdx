...
tags: ["active-directory","delegation","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Active Directory** track. It focuses on **Delegation concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.

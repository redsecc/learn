...
order: 10
summary: "Learn Domain concepts and terminology through a safe, repeatable active directory workflow."
tags: ["active-directory","domain","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Domain concepts and terminology** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Domain concepts and terminology is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Domain concepts and terminology" means in this track before using a tool.

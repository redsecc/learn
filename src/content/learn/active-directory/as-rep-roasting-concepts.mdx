---
title: "AS REP roasting concepts"
order: 21
summary: "Learn AS REP roasting concepts through a safe, repeatable active directory workflow."
tags: ["active-directory","as","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **AS REP roasting concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
AS REP roasting concepts is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "AS REP roasting concepts" means in this track before using a tool.

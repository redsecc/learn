...
tags: ["active-directory","group","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Active Directory** track. It focuses on **Group Policy overview** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["active-directory","password","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Active Directory** track. It focuses on **Password policy review** as a practical skill you can apply in labs, CTFs, and authorized assessments.

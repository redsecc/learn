...
order: 17
summary: "Learn Password policy review through a safe, repeatable active directory workflow."
tags: ["active-directory","password","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Password policy review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
- Define what "Password policy review" means in this track before using a tool.

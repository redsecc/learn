...
order: 16
summary: "Learn Local admin exposure through a safe, repeatable active directory workflow."
tags: ["active-directory","local","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Active Directory** track. It focuses on **Local admin exposure** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Local admin exposure is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Local admin exposure" means in this track before using a tool.

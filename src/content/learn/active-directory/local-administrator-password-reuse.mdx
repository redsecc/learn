---
title: "Local administrator password reuse"
order: 32
summary: "Learn Local administrator password reuse through a safe, repeatable active directory workflow."
tags: ["active-directory","local","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Active Directory** track. It focuses on **Local administrator password reuse** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Local administrator password reuse is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Local administrator password reuse" means in this track before using a tool.

---
title: "NTLM relay concepts in labs"
order: 30
summary: "Learn NTLM relay concepts in labs through a safe, repeatable active directory workflow."
tags: ["active-directory","ntlm","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Active Directory** track. It focuses on **NTLM relay concepts in labs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
NTLM relay concepts in labs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "NTLM relay concepts in labs" means in this track before using a tool.

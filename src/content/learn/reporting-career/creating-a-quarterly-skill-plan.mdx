---
title: "Creating a quarterly skill plan"
order: 29
summary: "Learn Creating a quarterly skill plan through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","creating","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Creating a quarterly skill plan** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Creating a quarterly skill plan is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Creating a quarterly skill plan" means in this track before using a tool.

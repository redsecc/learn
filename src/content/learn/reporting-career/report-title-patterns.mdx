---
title: "Report title patterns"
order: 10
summary: "Learn Report title patterns through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","report","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Report title patterns** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Report title patterns is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

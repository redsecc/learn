---
title: "Writing technical root cause"
order: 21
summary: "Learn Writing technical root cause through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","writing","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Writing technical root cause** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Writing technical root cause is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Writing technical root cause" means in this track before using a tool.

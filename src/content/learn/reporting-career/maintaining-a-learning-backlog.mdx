---
title: "Maintaining a learning backlog"
order: 19
summary: "Learn Maintaining a learning backlog through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","maintaining","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Maintaining a learning backlog** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Maintaining a learning backlog is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Maintaining a learning backlog" means in this track before using a tool.

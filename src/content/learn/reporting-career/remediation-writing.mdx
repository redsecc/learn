---
title: "Remediation writing"
order: 14
summary: "Learn Remediation writing through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","remediation","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Remediation writing** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Remediation writing is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Remediation writing" means in this track before using a tool.

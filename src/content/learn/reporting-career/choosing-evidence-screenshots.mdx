---
title: "Choosing evidence screenshots"
order: 23
summary: "Learn Choosing evidence screenshots through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","choosing","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Reporting and career** track. It focuses on **Choosing evidence screenshots** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Choosing evidence screenshots is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Choosing evidence screenshots" means in this track before using a tool.

---
title: "Bug bounty profile hygiene"
order: 27
summary: "Learn Bug bounty profile hygiene through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","bug","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Reporting and career** track. It focuses on **Bug bounty profile hygiene** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Bug bounty profile hygiene is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Bug bounty profile hygiene" means in this track before using a tool.

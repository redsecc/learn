---
title: "Building a redacted writeup"
order: 24
summary: "Learn Building a redacted writeup through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","building","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Building a redacted writeup** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Building a redacted writeup is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

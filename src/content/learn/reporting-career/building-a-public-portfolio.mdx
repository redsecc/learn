---
title: "Building a public portfolio"
order: 16
summary: "Learn Building a public portfolio through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","building","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Reporting and career** track. It focuses on **Building a public portfolio** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Building a public portfolio is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Building a public portfolio" means in this track before using a tool.

...
order: 13
summary: "Learn Severity reasoning through a safe, repeatable reporting and career workflow."
tags: ["reporting-career","severity","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Reporting and career** track. It focuses on **Severity reasoning** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Severity reasoning is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Severity reasoning" means in this track before using a tool.

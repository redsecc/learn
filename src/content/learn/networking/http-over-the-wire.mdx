...
tags: ["networking","http","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Networking** track. It focuses on **HTTP over the wire** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["networking","packet","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Networking** track. It focuses on **Packet capture with tcpdump** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
order: 14
summary: "Learn Routing and subnets through a safe, repeatable networking workflow."
tags: ["networking","routing","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Networking** track. It focuses on **Routing and subnets** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Routing and subnets is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Routing and subnets" means in this track before using a tool.

...
tags: ["networking","common","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Networking** track. It focuses on **Common service ports** as a practical skill you can apply in labs, CTFs, and authorized assessments.

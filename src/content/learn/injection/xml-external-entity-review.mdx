...
tags: ["injection","xml","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Injection** track. It focuses on **XML external entity review** as a practical skill you can apply in labs, CTFs, and authorized assessments.

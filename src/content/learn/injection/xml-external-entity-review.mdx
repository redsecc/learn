---
title: "XML external entity review"
order: 15
summary: "Learn XML external entity review through a safe, repeatable injection workflow."
tags: ["injection","xml","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **XML external entity review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
XML external entity review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

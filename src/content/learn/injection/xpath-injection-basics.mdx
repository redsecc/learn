---
title: "XPath injection basics"
order: 33
summary: "Learn XPath injection basics through a safe, repeatable injection workflow."
tags: ["injection","xpath","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **XPath injection basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
XPath injection basics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

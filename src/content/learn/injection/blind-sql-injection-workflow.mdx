---
title: "Blind SQL injection workflow"
order: 23
summary: "Learn Blind SQL injection workflow through a safe, repeatable injection workflow."
tags: ["injection","blind","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Injection** track. It focuses on **Blind SQL injection workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Blind SQL injection workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

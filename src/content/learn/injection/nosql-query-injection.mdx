...
order: 14
summary: "Learn NoSQL query injection through a safe, repeatable injection workflow."
tags: ["injection","nosql","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **NoSQL query injection** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
NoSQL query injection is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

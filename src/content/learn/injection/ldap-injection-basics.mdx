...
This lab is part of the **Injection** track. It focuses on **LDAP injection basics** as a practical skill you can apply in labs, CTFs, and authorized assessments.

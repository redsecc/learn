---
title: "Path traversal fundamentals"
order: 18
summary: "Learn Path traversal fundamentals through a safe, repeatable injection workflow."
tags: ["injection","path","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Injection** track. It focuses on **Path traversal fundamentals** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Path traversal fundamentals is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

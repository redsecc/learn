...
tags: ["injection","path","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **Path traversal fundamentals** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["injection","deserialization","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **Deserialization risk overview** as a practical skill you can apply in labs, CTFs, and authorized assessments.

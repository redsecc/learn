...
tags: ["injection","header","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Injection** track. It focuses on **Header injection and response splitting** as a practical skill you can apply in labs, CTFs, and authorized assessments.

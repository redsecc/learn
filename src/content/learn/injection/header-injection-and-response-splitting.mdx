---
title: "Header injection and response splitting"
order: 17
summary: "Learn Header injection and response splitting through a safe, repeatable injection workflow."
tags: ["injection","header","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Injection** track. It focuses on **Header injection and response splitting** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Header injection and response splitting is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

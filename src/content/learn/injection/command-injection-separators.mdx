---
title: "Command injection separators"
order: 25
summary: "Learn Command injection separators through a safe, repeatable injection workflow."
...
This tutorial is part of the **Injection** track. It focuses on **Command injection separators** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Command injection separators is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

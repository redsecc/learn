...
tags: ["access-control","shared","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Access control** track. It focuses on **Shared resource permissions** as a practical skill you can apply in labs, CTFs, and authorized assessments.

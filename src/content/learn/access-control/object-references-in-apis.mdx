...
tags: ["access-control","object","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Access control** track. It focuses on **Object references in APIs** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Horizontal vs vertical privilege"
order: 13
summary: "Learn Horizontal vs vertical privilege through a safe, repeatable access control workflow."
tags: ["access-control","horizontal","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Access control** track. It focuses on **Horizontal vs vertical privilege** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Horizontal vs vertical privilege is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

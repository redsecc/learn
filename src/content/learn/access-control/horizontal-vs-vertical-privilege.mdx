...
tags: ["access-control","horizontal","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Access control** track. It focuses on **Horizontal vs vertical privilege** as a practical skill you can apply in labs, CTFs, and authorized assessments.

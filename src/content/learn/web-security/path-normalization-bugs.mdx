---
title: "Path normalization bugs"
order: 28
summary: "Learn Path normalization bugs through a safe, repeatable web security workflow."
tags: ["web-security","path","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Web security** track. It focuses on **Path normalization bugs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Path normalization bugs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

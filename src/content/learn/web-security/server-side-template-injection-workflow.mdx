---
title: "Server side template injection workflow"
order: 32
summary: "Learn Server side template injection workflow through a safe, repeatable web security workflow."
tags: ["web-security","server","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Web security** track. It focuses on **Server side template injection workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Server side template injection workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

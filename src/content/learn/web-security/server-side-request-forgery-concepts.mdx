---
title: "Server-side request forgery concepts"
order: 14
summary: "Learn Server-side request forgery concepts through a safe, repeatable web security workflow."
tags: ["web-security","server","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Web security** track. It focuses on **Server-side request forgery concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Server-side request forgery concepts is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

...
tags: ["web-security","error","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Web security** track. It focuses on **Error handling and information leaks** as a practical skill you can apply in labs, CTFs, and authorized assessments.

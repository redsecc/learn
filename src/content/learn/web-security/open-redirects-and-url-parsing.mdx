...
tags: ["web-security","open","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Web security** track. It focuses on **Open redirects and URL parsing** as a practical skill you can apply in labs, CTFs, and authorized assessments.

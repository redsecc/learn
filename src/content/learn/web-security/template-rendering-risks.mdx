...
tags: ["web-security","template","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Web security** track. It focuses on **Template rendering risks** as a practical skill you can apply in labs, CTFs, and authorized assessments.

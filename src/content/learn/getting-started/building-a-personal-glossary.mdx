---
title: "Building a personal glossary"
order: 26
summary: "Learn Building a personal glossary through a safe, repeatable getting started workflow."
...
This tutorial is part of the **Getting started** track. It focuses on **Building a personal glossary** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Building a personal glossary is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Building a personal glossary" means in this track before using a tool.

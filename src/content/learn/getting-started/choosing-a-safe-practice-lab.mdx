---
title: "Choosing a safe practice lab"
order: 11
summary: "Learn Choosing a safe practice lab through a safe, repeatable getting started workflow."
tags: ["getting-started","choosing","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Choosing a safe practice lab** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Choosing a safe practice lab is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Choosing a safe practice lab" means in this track before using a tool.

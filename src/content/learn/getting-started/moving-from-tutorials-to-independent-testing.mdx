---
title: "Moving from tutorials to independent testing"
order: 19
summary: "Learn Moving from tutorials to independent testing through a safe, repeatable getting started workflow."
tags: ["getting-started","moving","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Moving from tutorials to independent testing** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Moving from tutorials to independent testing is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Moving from tutorials to independent testing" means in this track before using a tool.

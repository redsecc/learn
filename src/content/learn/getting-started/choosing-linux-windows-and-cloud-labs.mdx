---
title: "Choosing Linux, Windows, and cloud labs"
order: 21
summary: "Learn Choosing Linux, Windows, and cloud labs through a safe, repeatable getting started workflow."
tags: ["getting-started","choosing","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Choosing Linux, Windows, and cloud labs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Choosing Linux, Windows, and cloud labs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Choosing Linux, Windows, and cloud labs" means in this track before using a tool.

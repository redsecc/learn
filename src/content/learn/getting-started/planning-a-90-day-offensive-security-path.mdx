---
title: "Planning a 90 day offensive security path"
order: 28
summary: "Learn Planning a 90 day offensive security path through a safe, repeatable getting started workflow."
tags: ["getting-started","planning","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Planning a 90 day offensive security path** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Planning a 90 day offensive security path is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Planning a 90 day offensive security path" means in this track before using a tool.

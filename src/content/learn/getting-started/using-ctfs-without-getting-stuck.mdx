...
tags: ["getting-started","using","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Getting started** track. It focuses on **Using CTFs without getting stuck** as a practical skill you can apply in labs, CTFs, and authorized assessments.

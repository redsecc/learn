---
title: "Tracking commands, screenshots, and evidence"
order: 25
summary: "Learn Tracking commands, screenshots, and evidence through a safe, repeatable getting started workflow."
tags: ["getting-started","tracking","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Tracking commands, screenshots, and evidence** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Tracking commands, screenshots, and evidence is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Tracking commands, screenshots, and evidence" means in this track before using a tool.

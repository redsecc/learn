---
title: "Learning roadmap for offensive security"
order: 10
summary: "Learn Learning roadmap for offensive security through a safe, repeatable getting started workflow."
tags: ["getting-started","learning","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Learning roadmap for offensive security** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Learning roadmap for offensive security is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Learning roadmap for offensive security" means in this track before using a tool.

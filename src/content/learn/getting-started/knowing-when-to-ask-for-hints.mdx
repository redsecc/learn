---
title: "Knowing when to ask for hints"
order: 29
summary: "Learn Knowing when to ask for hints through a safe, repeatable getting started workflow."
tags: ["getting-started","knowing","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Knowing when to ask for hints** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Knowing when to ask for hints is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Knowing when to ask for hints" means in this track before using a tool.

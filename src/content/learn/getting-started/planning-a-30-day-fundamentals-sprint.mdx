---
title: "Planning a 30 day fundamentals sprint"
order: 27
summary: "Learn Planning a 30 day fundamentals sprint through a safe, repeatable getting started workflow."
tags: ["getting-started","planning","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Getting started** track. It focuses on **Planning a 30 day fundamentals sprint** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Planning a 30 day fundamentals sprint is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Planning a 30 day fundamentals sprint" means in this track before using a tool.

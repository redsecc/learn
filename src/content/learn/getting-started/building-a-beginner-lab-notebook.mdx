---
title: "Building a beginner lab notebook"
order: 20
summary: "Learn Building a beginner lab notebook through a safe, repeatable getting started workflow."
tags: ["getting-started","building","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Building a beginner lab notebook** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Building a beginner lab notebook is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Building a beginner lab notebook" means in this track before using a tool.

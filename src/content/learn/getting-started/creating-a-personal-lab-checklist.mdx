...
tags: ["getting-started","creating","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Getting started** track. It focuses on **Creating a personal lab checklist** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Creating a personal lab checklist"
order: 17
summary: "Learn Creating a personal lab checklist through a safe, repeatable getting started workflow."
tags: ["getting-started","creating","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Creating a personal lab checklist** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Creating a personal lab checklist is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Creating a personal lab checklist" means in this track before using a tool.

---
title: "Understanding authorization and scope"
order: 16
summary: "Learn Understanding authorization and scope through a safe, repeatable getting started workflow."
tags: ["getting-started","understanding","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Getting started** track. It focuses on **Understanding authorization and scope** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Understanding authorization and scope is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Understanding authorization and scope" means in this track before using a tool.

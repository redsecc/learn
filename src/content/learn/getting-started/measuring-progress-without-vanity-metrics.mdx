---
title: "Measuring progress without vanity metrics"
order: 18
summary: "Learn Measuring progress without vanity metrics through a safe, repeatable getting started workflow."
tags: ["getting-started","measuring","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Getting started** track. It focuses on **Measuring progress without vanity metrics** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Measuring progress without vanity metrics is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Measuring progress without vanity metrics" means in this track before using a tool.

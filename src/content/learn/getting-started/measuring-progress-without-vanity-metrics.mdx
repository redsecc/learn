...
tags: ["getting-started","measuring","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Getting started** track. It focuses on **Measuring progress without vanity metrics** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "How to avoid tutorial dependence"
order: 23
summary: "Learn How to avoid tutorial dependence through a safe, repeatable getting started workflow."
tags: ["getting-started","how","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Getting started** track. It focuses on **How to avoid tutorial dependence** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
How to avoid tutorial dependence is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "How to avoid tutorial dependence" means in this track before using a tool.

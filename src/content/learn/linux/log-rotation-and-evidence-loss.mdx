---
title: "Log rotation and evidence loss"
order: 28
summary: "Learn Log rotation and evidence loss through a safe, repeatable linux workflow."
tags: ["linux","log","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Linux** track. It focuses on **Log rotation and evidence loss** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Log rotation and evidence loss is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Log rotation and evidence loss" means in this track before using a tool.

...
This lab is part of the **Linux** track. It focuses on **Package managers and installed software** as a practical skill you can apply in labs, CTFs, and authorized assessments.

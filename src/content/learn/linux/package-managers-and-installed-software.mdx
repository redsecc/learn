---
title: "Package managers and installed software"
order: 17
summary: "Learn Package managers and installed software through a safe, repeatable linux workflow."
tags: ["linux","package","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Linux** track. It focuses on **Package managers and installed software** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Package managers and installed software is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Package managers and installed software" means in this track before using a tool.
...
<Callout type="tip" title="Lab exercise">
  Use a disposable Linux VM or container. Make one change at a time, record it, then revert or rebuild when the system becomes messy.
</Callout>

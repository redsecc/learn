---
title: "Writable directories and sticky bit"
order: 24
summary: "Learn Writable directories and sticky bit through a safe, repeatable linux workflow."
tags: ["linux","writable","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Linux** track. It focuses on **Writable directories and sticky bit** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Writable directories and sticky bit is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Writable directories and sticky bit" means in this track before using a tool.

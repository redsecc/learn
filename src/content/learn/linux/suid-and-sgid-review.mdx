---
title: "SUID and SGID review"
order: 18
summary: "Learn SUID and SGID review through a safe, repeatable linux workflow."
tags: ["linux","suid","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Linux** track. It focuses on **SUID and SGID review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
SUID and SGID review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "SUID and SGID review" means in this track before using a tool.

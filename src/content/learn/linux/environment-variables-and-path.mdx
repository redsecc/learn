...
tags: ["linux","environment","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Linux** track. It focuses on **Environment variables and PATH** as a practical skill you can apply in labs, CTFs, and authorized assessments.

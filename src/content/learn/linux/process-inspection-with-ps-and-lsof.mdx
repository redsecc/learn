---
title: "Process inspection with ps and lsof"
order: 31
summary: "Learn Process inspection with ps and lsof through a safe, repeatable linux workflow."
tags: ["linux","process","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Linux** track. It focuses on **Process inspection with ps and lsof** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Process inspection with ps and lsof is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Process inspection with ps and lsof" means in this track before using a tool.

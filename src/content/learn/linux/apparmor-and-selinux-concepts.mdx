---
title: "AppArmor and SELinux concepts"
order: 34
summary: "Learn AppArmor and SELinux concepts through a safe, repeatable linux workflow."
tags: ["linux","apparmor","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Linux** track. It focuses on **AppArmor and SELinux concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
AppArmor and SELinux concepts is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "AppArmor and SELinux concepts" means in this track before using a tool.

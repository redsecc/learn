...
tags: ["authentication","account","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Authentication** track. It focuses on **Account enumeration signals** as a practical skill you can apply in labs, CTFs, and authorized assessments.

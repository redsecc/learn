---
title: "MFA enrollment and recovery"
order: 12
summary: "Learn MFA enrollment and recovery through a safe, repeatable authentication workflow."
tags: ["authentication","mfa","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Authentication** track. It focuses on **MFA enrollment and recovery** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
MFA enrollment and recovery is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

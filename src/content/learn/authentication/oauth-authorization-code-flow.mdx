...
tags: ["authentication","oauth","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Authentication** track. It focuses on **OAuth authorization code flow** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "MFA code replay testing"
order: 27
summary: "Learn MFA code replay testing through a safe, repeatable authentication workflow."
tags: ["authentication","mfa","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Authentication** track. It focuses on **MFA code replay testing** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
MFA code replay testing is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

---
title: "CTF writeup templates by category"
order: 79
summary: "Learn CTF writeup templates by category through a safe, repeatable ctfs workflow."
tags: ["ctfs","ctf","advanced","reference"]
level: advanced
kind: reference
duration: "12 min"
---
...
This reference is part of the **CTFs** track. It focuses on **CTF writeup templates by category** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CTF writeup templates by category is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

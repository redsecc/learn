...
tags: ["ctfs","forensics","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **CTFs** track. It focuses on **Forensics CTF first pass** as a practical skill you can apply in labs, CTFs, and authorized assessments.

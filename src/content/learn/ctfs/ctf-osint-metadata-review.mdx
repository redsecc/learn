---
title: "CTF OSINT metadata review"
order: 56
summary: "Learn CTF OSINT metadata review through a safe, repeatable ctfs workflow."
...
This tutorial is part of the **CTFs** track. It focuses on **CTF OSINT metadata review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CTF OSINT metadata review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

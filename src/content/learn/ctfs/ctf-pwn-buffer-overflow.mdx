---
title: "CTF pwn buffer overflow"
order: 29
summary: "Learn CTF pwn buffer overflow through a safe, repeatable ctfs workflow."
tags: ["ctfs","ctf","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **CTFs** track. It focuses on **CTF pwn buffer overflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CTF pwn buffer overflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

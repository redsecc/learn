...
tags: ["ctfs","reverse","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **CTFs** track. It focuses on **Reverse CTF first pass** as a practical skill you can apply in labs, CTFs, and authorized assessments.

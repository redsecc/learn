---
title: "CTF OSINT image geolocation"
order: 53
summary: "Learn CTF OSINT image geolocation through a safe, repeatable ctfs workflow."
...
This tutorial is part of the **CTFs** track. It focuses on **CTF OSINT image geolocation** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CTF OSINT image geolocation is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

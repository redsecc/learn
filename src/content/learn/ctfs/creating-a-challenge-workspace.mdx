---
title: "Creating a challenge workspace"
order: 12
summary: "Learn Creating a challenge workspace through a safe, repeatable ctfs workflow."
tags: ["ctfs","creating","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **CTFs** track. It focuses on **Creating a challenge workspace** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Creating a challenge workspace is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

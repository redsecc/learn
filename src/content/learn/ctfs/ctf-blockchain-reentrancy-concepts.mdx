---
title: "CTF blockchain reentrancy concepts"
order: 62
summary: "Learn CTF blockchain reentrancy concepts through a safe, repeatable ctfs workflow."
...
This tutorial is part of the **CTFs** track. It focuses on **CTF blockchain reentrancy concepts** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
CTF blockchain reentrancy concepts is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.

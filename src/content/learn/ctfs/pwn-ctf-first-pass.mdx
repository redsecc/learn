...
This lab is part of the **CTFs** track. It focuses on **Pwn CTF first pass** as a practical skill you can apply in labs, CTFs, and authorized assessments.

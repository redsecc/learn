---
title: "Finding forgotten admin features"
order: 31
summary: "Learn Finding forgotten admin features through a safe, repeatable finding vulnerabilities workflow."
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Finding forgotten admin features** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Finding forgotten admin features is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Finding forgotten admin features" means in this track before using a tool.

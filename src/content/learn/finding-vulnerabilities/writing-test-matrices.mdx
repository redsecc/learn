---
title: "Writing test matrices"
order: 18
summary: "Learn Writing test matrices through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","writing","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Finding vulnerabilities** track. It focuses on **Writing test matrices** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Writing test matrices is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Writing test matrices" means in this track before using a tool.

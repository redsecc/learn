...
tags: ["finding-vulnerabilities","writing","advanced","tutorial"]
level: advanced
kind: tutorial
duration: "35 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Writing test matrices** as a practical skill you can apply in labs, CTFs, and authorized assessments.

...
tags: ["finding-vulnerabilities","state","intro","lab"]
level: intro
kind: lab
duration: "30 min"
---
...
This lab is part of the **Finding vulnerabilities** track. It focuses on **State change testing** as a practical skill you can apply in labs, CTFs, and authorized assessments.

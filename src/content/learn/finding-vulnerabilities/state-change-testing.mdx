---
title: "State change testing"
order: 13
summary: "Learn State change testing through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","state","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **State change testing** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
State change testing is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "State change testing" means in this track before using a tool.

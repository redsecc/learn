---
title: "Chaining SSRF to metadata in labs"
order: 30
summary: "Learn Chaining SSRF to metadata in labs through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","chaining","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Finding vulnerabilities** track. It focuses on **Chaining SSRF to metadata in labs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Chaining SSRF to metadata in labs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Chaining SSRF to metadata in labs" means in this track before using a tool.

...
tags: ["finding-vulnerabilities","finding","core","lab"]
level: core
kind: lab
duration: "30 min"
---
...
This lab is part of the **Finding vulnerabilities** track. It focuses on **Finding hidden assumptions** as a practical skill you can apply in labs, CTFs, and authorized assessments.

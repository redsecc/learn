...
order: 17
summary: "Learn Finding hidden assumptions through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","finding","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Finding hidden assumptions** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Finding hidden assumptions is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Finding hidden assumptions" means in this track before using a tool.

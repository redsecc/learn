---
title: "Finding export and import bugs"
order: 33
summary: "Learn Finding export and import bugs through a safe, repeatable finding vulnerabilities workflow."
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Finding export and import bugs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Finding export and import bugs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Finding export and import bugs" means in this track before using a tool.

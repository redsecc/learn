---
title: "Ending a target review"
order: 19
summary: "Learn Ending a target review through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","ending","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Ending a target review** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Ending a target review is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Ending a target review" means in this track before using a tool.

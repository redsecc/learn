---
title: "Input inventory techniques"
order: 12
summary: "Learn Input inventory techniques through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","input","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Input inventory techniques** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Input inventory techniques is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Input inventory techniques" means in this track before using a tool.

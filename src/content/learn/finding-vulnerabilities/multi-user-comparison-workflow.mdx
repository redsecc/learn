---
title: "Multi user comparison workflow"
order: 23
summary: "Learn Multi user comparison workflow through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","multi","core","reference"]
level: core
kind: reference
duration: "12 min"
---
...
This reference is part of the **Finding vulnerabilities** track. It focuses on **Multi user comparison workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Multi user comparison workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Multi user comparison workflow" means in this track before using a tool.

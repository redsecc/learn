---
title: "HTTP method matrix"
order: 22
summary: "Learn HTTP method matrix through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","http","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **HTTP method matrix** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
HTTP method matrix is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "HTTP method matrix" means in this track before using a tool.

---
title: "Endpoint inventory by role"
order: 20
summary: "Learn Endpoint inventory by role through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","endpoint","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Endpoint inventory by role** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Endpoint inventory by role is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Endpoint inventory by role" means in this track before using a tool.

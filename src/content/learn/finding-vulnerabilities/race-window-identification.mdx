---
title: "Race window identification"
order: 26
summary: "Learn Race window identification through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","race","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Race window identification** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Race window identification is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Race window identification" means in this track before using a tool.

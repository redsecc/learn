...
order: 10
summary: "Learn Attack surface mapping through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","attack","intro","tutorial"]
level: intro
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Attack surface mapping** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Attack surface mapping is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Attack surface mapping" means in this track before using a tool.

---
title: "Finding notification workflow bugs"
order: 34
summary: "Learn Finding notification workflow bugs through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","finding","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Finding notification workflow bugs** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Finding notification workflow bugs is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Finding notification workflow bugs" means in this track before using a tool.

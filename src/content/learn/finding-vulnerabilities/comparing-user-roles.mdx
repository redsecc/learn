...
tags: ["finding-vulnerabilities","comparing","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Comparing user roles** as a practical skill you can apply in labs, CTFs, and authorized assessments.

---
title: "Comparing user roles"
order: 16
summary: "Learn Comparing user roles through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","comparing","intro","reference"]
level: intro
kind: reference
duration: "12 min"
---
...
This reference is part of the **Finding vulnerabilities** track. It focuses on **Comparing user roles** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Comparing user roles is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Comparing user roles" means in this track before using a tool.

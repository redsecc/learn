---
title: "Parameter tampering workflow"
order: 21
summary: "Learn Parameter tampering workflow through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","parameter","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Parameter tampering workflow** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Parameter tampering workflow is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Parameter tampering workflow" means in this track before using a tool.

---
title: "Negative testing mindset"
order: 24
summary: "Learn Negative testing mindset through a safe, repeatable finding vulnerabilities workflow."
tags: ["finding-vulnerabilities","negative","core","tutorial"]
level: core
kind: tutorial
duration: "20 min"
---
...
This tutorial is part of the **Finding vulnerabilities** track. It focuses on **Negative testing mindset** as a practical skill you can apply in labs, CTFs, and authorized assessments.
...
Negative testing mindset is useful when you can explain the system in front of you before you touch it. Start by naming the asset, the user, the trust boundary, and the expected control. Then compare the expected behavior with what the system actually does.
...
- Define what "Negative testing mindset" means in this track before using a tool.
